...
<head>
    ...
    <meta property="og:title" content="{{ $seo->meta_title ?? 'Terms of Service | Solution Hub' }}">
    <meta property="og:description" content="{{ $seo->meta_description ?? 'Read the Solution Hub terms of service.' }}">
